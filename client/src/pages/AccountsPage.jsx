  ...
  company: [
    {
      ...
      balance: "15,400.00",
      number: "**** **** **** 9900",
      status: "Pending Verification", // From PDF: Quotation requirement
      theme: "dark",
    },
  ],
};
...
const TRANSACTIONS = [
  ...
  },
  {
    id: "TX103",
    date: "Nov 24, 2025",
    desc: "Sarif Exchange (USD to SLSH)",
    type: "debit",
    amount: "- $50.00",
    status: "Completed",
  },
...
export default function MyAccountsPage() {
  const [selectedAccount, setSelectedAccount] = useState(ACCOUNTS.personal[0]);
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="personal" className="w-full">
        ...
        {/* PERSONAL ACCOUNTS CONTENT */}
        <TabsContent value="personal" className="space-y-6">
          {/* CARDS GRID */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ACCOUNTS.personal.map((acc) => (
              <div
                key={acc.id}
          ...
          <div className="grid lg:grid-cols-3 gap-6 mt-8">
            ...
            <Card className="lg:col-span-1 h-fit shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Manage {selectedAccount.currency} **** 4242
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                >
                  <ShieldCheck className="mr-2 h-4 w-4" /> Freeze Card
                </Button>
        ...
        {/* COMPANY ACCOUNTS CONTENT (Demo for PDF Requirement) */}
